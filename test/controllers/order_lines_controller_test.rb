...
class OrderLinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_line" do
    assert_difference('OrderLine.count') do
      post order_lines_url, params: { order_line: { : @order_line., countity: @order_line.countity, good: @order_line.good, order_id: @order_line.order_id, price,sum: @order_line.price,sum } }
    end
  ...
  test "should update order_line" do
    patch order_line_url(@order_line), params: { order_line: { : @order_line., countity: @order_line.countity, good: @order_line.good, order_id: @order_line.order_id, price,sum: @order_line.price,sum } }
